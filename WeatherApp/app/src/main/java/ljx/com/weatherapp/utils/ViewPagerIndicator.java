...
import ljx.com.weatherapp.Activity.MainActivity;
...
public class ViewPagerIndicator implements ViewPager.OnPageChangeListener {
    ...
    private int size;
    private int img1 = R.mipmap.viewpage_point_true, img2 = R.mipmap.viewpage_point_false;
    ...
    public void onPageSelected(int position) {
        for (int i = 0; i < size; i++) {            //选中的页面改变小圆点为选中状态，反之为未选中
            if ((position % size) == i) {
